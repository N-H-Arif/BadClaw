...
This repository contains NeurIPS submission code for BadClaw: Identifying and Benchmarking Dimensional Trigger Attacks in Self-Hosted Agentic Systems. It studies cases where trigger evidence is distributed across time, system locations, and persistent context, then combines during routing, planning, or tool execution.
